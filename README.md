# SolarPower
Проект "SolarPower" направлен на разработку автономной системы энергоснабжения для маяка, с использованием солнечных панелей. Основная цель проекта — обеспечить бесперебойную работу маяка в условиях отсутствия централизованного энергоснабжения.
...
* Аккумулятор 18650
Литий-ионный аккумулятор стандартного размера (18 мм в диаметре, 65 мм в длину). Широко используется в электронике благодаря высокой емкости, стабильности и долговечности.

* Плата контроля питания TP4056
Модуль для зарядки литий-ионных аккумуляторов. Обеспечивает безопасную зарядку с контролем тока и напряжения, а также защиту от перезаряда и переразряда.

* Повышающий преобразователь MT3608 DC-DC
Модуль для повышения напряжения от низкого уровня (например, 2 В) до более высокого (до 28 В). Используется для питания устройств, требующих большего напряжения, чем может предоставить источник.

* Солнечная панель
Устройство, преобразующее солнечную энергию в электрическую. Используется в автономных системах питания, например, для зарядки аккумуляторов или питания маломощных устройств.

* Металлический сервопривод MG995
Мощный сервопривод с металлическими шестернями, способный создавать высокий крутящий момент. Используется в робототехнике и механических системах для точного управления углом поворота.

* Светодиоды
Полупроводниковые источники света с низким энергопотреблением. Широко применяются в индикации, подсветке и декоративных целях благодаря своей яркости и долговечности.

* Микроконтроллеры Arduino Nano и Arduino Uno
Платы на базе микроконтроллеров для создания электронных проектов. Arduino Uno имеет больше входов/выходов и подходит для более сложных задач, а Arduino Nano компактнее и удобнее для небольших проектов.

* Фоторезистор GREATZT 5528
Компонент, изменяющий свое сопротивление в зависимости от интенсивности света. Используется в системах автоматического управления освещением, датчиках света и других устройствах, реагирующих на уровень освещенности.
